  ...
  try {
    ...
    if (data.results.length > 0) {
      ...
      return {
        ...
        genres: genres, // Include genre names
        overview: movieDetailsData.overview, // Original overview
        shorterOverview: truncateOverview(shorterOverview, 100), // Include shorter description
      };
    } else {
      return null;
    }
